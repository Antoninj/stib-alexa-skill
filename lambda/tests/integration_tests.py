...
class StibScheduleTestSuite(AlexaSkillTest):
    ...
    def test_commute_preferences_intent(self):
        ...
        conversation = [{'slot': None, 'text': 'open stib schedule ', 'prompt': None},
                        {'slot': 'stop_id', 'text': 'one thousand fifty nine', 'prompt': 'At which stop do you start your journey?'},
                        {'slot': 'line_id', 'text': 'ninety three', 'prompt': 'Which line do you take?'}]
